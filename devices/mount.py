...
#                f'coordinate_system': str(self.rdsys),
            ...
            #         plog ("There is a TheSkyX undetermined error. Re-parking and waiting for further instructions from the site-code.")
            #         breakpoint()
            #         self.home_command()
            #         self.park_command()
            #         wait_for_slew()
...
# =============================================================================
    ...
    def go_command(self, req, opt,  offset=False, calibrate=False, auto_center=False):
        ...
        if g_dev['seq'].morn_sky_flat_latch  or g_dev['seq'].eve_sky_flat_latch or g_dev['seq'].sky_flat_latch:
            g_dev['obs'].send_to_user("Refusing pointing request as the observatory is currently undertaking flats.")
            plog("Refusing pointing request as the observatory is currently taking flats.")
            return
