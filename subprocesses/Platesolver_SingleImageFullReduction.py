...
for extension in extensions:
    ...
    if not os.path.exists(filepath + extension):
        os.makedirs(filepath  + extension, mode=0o777)

    
    #Check that the individual sequence directory is constructed
    tempdir=filepath + extension + '/temp'
    ...
    wslfilename=filepath  + extension + '/' + filebase
    ...
    if extension =='B1':
        hdufocus.data=hdufocusdata[1::2, 1::2]
    elif extension =='G1':
        hdufocus.data=hdufocusdata[::2, 1::2]
    elif extension =='G2':
        hdufocus.data=hdufocusdata[1::2, ::2]
    elif extension =='R1':
        hdufocus.data=hdufocusdata[::2, ::2]
    elif extension =='CV':
        hdufocus.data=block_reduce(hdufocusdata,2)
    else:
    ...
    #tempdir='temporary'
    #codedir='temporary'
    fwhmfilename=filepath + extension  + '/' + filebase.replace('.fits','.fwhm')
