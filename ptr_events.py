...
class Events:
    ...
    def __init__(self, config: dict):
        ...
        self.siteLatitude = round(float(self.config['obs_latitude']), 8)  # 34 20 34.569   #34 + (20 + 34.549/60.)/60.
        self.siteLongitude = round(float(self.config['obs_longitude']), 8)  # -(119 + (40 + 52.061/60.)/60.) 119 40 52.061 W
        self.siteElevation = round(float(self.config['obs_elevation']), 3)
