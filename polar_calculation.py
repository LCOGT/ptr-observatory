...
ARO polar axis is ideally -68 sec, so 68 asec above the true pole.
...
print("Polar Axis alignment derived from Tpoint run 20240524-3.DAT.")
print('\n')
print("Elevation Error:  ", ME, "asec.     Azimuth error:  ", MA, "asec.")
print('\n')
print("Note, 4 spokes on the elevation wheel, so 1 spoke = 0.25 turns. \n")
if alt < 0:
    print("Elevation Adjustment:  ", -alt, 'Raise Tel axis above Pole, lower tail of Tel.')
    ...
    print("Elevation Adjustment:  ", alt, 'asec   Lower Tel axis to Pole, raise tail of Tel. \n')
    print("Pick one of the two following options.")
...
if az > 0:
   ...
   print("Azimuth Adjustment:  ", small_az, 'small graduations COUNTER-CLOCKWISE, as seen from above. \n \
          LoosenRLEFT knob to make room for counter-clockwise travel \n \
