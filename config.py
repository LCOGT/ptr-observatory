...
site_config = {
    ...
    'site_in_automatic_default': "Manual",   #['Shutdown', 'Maunual', 'Automatic']
    ...
    'camera': {
        ...
        'camera_1': {
            ...
            'settings': {
                ...
                'default_area':  "Full",
                'bin_modes':  [[2, 2, 0.6050], [3, 3, 0.907], [1, 1, 0.303], [4, 4, 1.21]],     #Meaning fixed binning if list has only one entry
