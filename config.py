...
# =============================================================================
    ...
    'telescope': {
        'telescope1': {
            ...
            'recover_script':  None,
            'shutdown_script':  None,  
            'collecting_area':  76147,    #  Corrected 20220424
            'obscuration':  23.5,
            'aperture': 356,
        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'abbreviation'],
                                ['air',     [0, 0], -1000,  82,  [2, 17], 'ai'], # 0
                                ['dif',     [4, 0],     0,  72,  [2, 17], 'df'], # 1
                                ['w',       [2, 0],     0,  75,  [2, 17], 'w '], # 2
                                ['CR',      [1, 0],     0,  .56,   [2, 17], 'CR'], # 3
                                ['N2',      [3, 0],     0,  .32,   [2, 17], 'N2'], # 4
                                ['up',      [0, 5],     0,  1.4,   [1, 17], 'up'], # 5
                                ['gp',      [0, 6],     0,  49.4,  [2, 17], 'gp'], # 6
                                ['rp',      [0, 7],     0,  17.5,   [2, 17], 'rp'], # 7
                                ['ip',      [0, 8],     0,  5.2,   [2, 17], 'ip'], # 8
                                ['z',       [5, 0],     0,  .9,    [2, 17], 'z'], # 9
                                ['PL',      [0, 4],     0,  75,   [2, 17], "PL"], # 10
                                ['PR',      [0, 3],     0,  14,   [2, 17], 'PR'], # 11
                                ['PG',      [0, 2],     0,  19,   [2, 17], 'PG'], # 12
                                ['PB',      [0, 1],     0,  37,   [2, 17], 'PB'], # 13
                                ['O3',      [7, 0],     0,  1.8,  [2, 17], '03'], # 14
                                ['HA',      [6, 0],     0,  .54,  [2, 17], 'HA'], # 15
                                ['S2',      [8, 0],     0,  0.3,  [2, 17], 'S2'], # 16
                                ['difup',   [4, 5],     0,  1.3,  [2, 17], 'du'], # 17
                                ['difgp',   [4, 6],     0,  47,   [2, 17], 'dg'], # 18
                                ['difrp',   [4, 7],     0,  16,   [2, 17], 'dr'], # 19
                                ['difip',   [4, 8],     0,  4.9,  [2, 17], 'di'], # 20
