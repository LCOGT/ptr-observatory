        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'generic'],
                        ...
                        ['Lum',  [7,  0],    0, 72.8, [360 , 170], 'w '],    # 1.
                        ['Red',  [0,  8],    0, 72.8, [360 , 170], 'w '],    # 1.
                        ['Green',[0 , 7],    0, 72.8, [360 , 170], 'w '],    # 1.
                        ['Blue', [0,  6],    0, 72.8, [360 , 170], 'w '],    # 1.
                        ...
                        ['PG (Grn)',   [0,  7],    0, 18.6, [30  , 170], 'PG'],    #16.
                        ['PB (Blu)',   [0,  6],    0, 42.3, [360 , 170], 'PR'],    #17.
