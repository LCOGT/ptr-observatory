...
site_config = {
    ...
    'telescope': {
        'telescope1': {
            ...
            'instrument names':  ['camera1', 'spectrograph1', 'camera2', 'spectrograph2'],
            'instrument aliases':  ['QHY600Mone', 'Alpy', 'FLI 16803', 'Fiber Echelle'],
            # 'configuration: {
            #      "position1": {
            #          'darkslide1',
            },
    ...
    'selector': {
        'selector1': {
            ...
            'recover_script':  None,
            'shutdown_script':  None,
            'instruments':  ['main_camera', 'eShel', 'color_camera', 'UVEX'],
            'cameras':  ['camera1', 'camera2', 'camera3', 'camera4'],
            'guiders':  [None, 'guider2', None, 'guider4'],
            'default': 0
            },
