        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'generic'],
                        ...
                        ['air',  [0,  0], -800, 22.1, [2   ,  20], 'air'],   # 1
                        ['w',    [7,  0],    0, 0.20, [360 , 170], 'L'],     # 2
                        ['up',   [1,  0],    0, 22.1, [2   ,  20], 'u'],     # 3
                        ['gp',   [2,  0],    0, 17.4, [.77 ,  20], 'g'],     # 4
                        ['rp',   [3,  0],    0, 11.0, [1.2 ,  20], 'r'],     # 5
                        ['ip',   [4,  0],    0, 37.4, [.65 ,  20], 'i'],     # 6
                        ['zs',   [5,  0],    0, 11.6, [1.0 ,  20], 'zs'],    # 7
                        ['zp',   [0,  9],    0, 0.21, [360 , 170], 'z'],     # 8
                        ['Y',    [6,  0],    0, 0.73, [360 , 170], 'y'],     # 9
                        ['EXO',  [8,  0],    0, 0.21, [360 , 170], 'exo'],   #10
                        ['JB',   [9,  0],    0, 27.5, [0.65,  20], 'BB'],    #11
                        ['JV',   [10, 0],    0, 62.3, [.32 ,  20], 'BV'],    #12
                        ['Rc',   [11, 0],    0, 2.99, [10  , 170], 'BR'],    #13
                        ['Ic',   [12, 0],    0, 0.73, [360 , 170], 'BI'],    #14
                        ['L',    [7,  0],    0, 0.20, [360 , 170], 'L'],     #15
                        ['PR',   [0,  8],    0, 62.3, [.32 ,  20], 'PB'],    #16
                        ['PG',   [0,  7],    0, 0.10, [30  , 170], 'PG'],    #17
                        ['PB',   [0,  6],    0, 0.20, [360 , 170], 'PR'],    #18
                        ['NIR',  [0, 10],    0, 27.5, [0.65,  20], 'ex'],    #19
                        ['O3',   [0,  2],    0, 0.21, [360 , 170], 'OIII'],  #20
                        ['HA',   [0,  3],    0, 0.20, [360 , 170], 'Ha'],    #21
                        ['N2',   [13, 0],    0, 0.20, [360 , 170], 'NII'],   #22
                        ['S2',   [0,  4],    0, 27.5, [0.65,  20], 'SII'],   #23
                        ['CR',   [0,  5],    0, 0.20, [360 , 170], 'Rc'],    #24
                        ['dif',  [0,  1],    0, 0.21, [360 , 170], 'dif'],   #25
                        ['difw',   [7,  1],  0, 27.5, [0.65,  20], 'ex'],    #26
                        ['difup',  [1,  1],  0, 27.5, [0.65,  20], 'ex'],    #27
                        ['difgp',  [2,  1],  0, 27.5, [0.65,  20], 'ex'],    #28
                        ['difrp',  [3,  1],  0, 27.5, [0.65,  20], 'ex'],    #29
                        ['difip',  [4,  1],  0, 27.5, [0.65,  20], 'ex'],    #30
                        ['difzs',  [5,  1],  0, 27.5, [0.65,  20], 'ex'],    #31
                        ['difY',   [6,  1],  0, 27.5, [0.65,  20], 'ex'],    #32
                        ['difexo', [8,  1],  0, 27.5, [0.65,  20], 'ex'],    #33
                        ['difJB',  [9,  1],  0, 27.5, [0.65,  20], 'ex'],    #34
                        ['difJV',  [10, 1],  0, 27.5, [0.65,  20], 'ex'],    #35
                        ['difRc',  [11, 1],  0, 27.5, [0.65,  20], 'ex'],    #36
                        ['difIc',  [12, 1],  0, 27.5, [0.65,  20], 'ex']],   #37
