...
site_config = {
    ...
    'mount': {
        'mount1': {
            ...
            'east_clutch_ra_correction':   0, #  In principle these should not be needed on an Alt-Az or fork with
            'east_clutch_dec_correction': 0,  #    own mount model.
            'west_clutch_ha_correction':  0.0, #-52*0.5751/3600/15,    #incoming unit is pixels, outgoing is min or degrees. 20201230
            'west_clutch_dec_correction': 0.0, #356*0.5751/3600,  #Altair was Low and right, so too South and too West.
            'settings': {
