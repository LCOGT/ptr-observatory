    ...
    'camera': {
        ...
        'camera_1_1': {
            ...
            'settings': {
                ...
                'bin_modes':  [[2, 2, 0.937], [1, 1, 0.469], [3, 3, 1.45], [4, 4, 1.87]],   #Meaning no binning choice if list has only one entry, default should be first.
...
# =============================================================================
    ...
    'filter_wheel': {
        "filter_wheel1": {
            ...
            "driver": ['ASCOM.Apogee.FilterWheel', 'ASCOM.Apogee2.FilterWheel'], #['ASCOM.Apogee.FilterWheel', 'ASCOM.Apogee.FilterWheel2'],   #"Maxim",   #
    ...
    'camera': {
        ...
        'camera_1_1': {
            ...
            'desc':  'QHY 600M Pro',
            'driver':  'ASCOM.FLI.Kepler.Camera', #"Maxim.CCDCamera",   #'ASCOM.FLI.Kepler.Camera', "ASCOM.QHYCCD.Camera",   #
