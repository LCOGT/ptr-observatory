...
#
    'camera': {
        ...
        # 'camera_2': {
        #     'parent': 'telescope1',
        #     'alias': 'sq02',      #Important because this points to a server file structure by that name.
        #     'desc':  'QHY 268M',
        ...
        # 'camera_4': {
        #     'parent': 'telescope1',
        #     'alias': 'zs01',      #Important because this points to a server file structure by that name.
        #     'desc':  'ASI',
        #     'driver':  'ASCOM.FLI.Camera',   #"Maxim.CCDCamera",   #'ASCOM.FLI.Kepler.Camera',  #Code must work withall three
        #     'startup_script':  None,
        #     'recover_script':  None,
        ...
        # 'ag_1_2': {
        #     'parent': 'telescope1',
        #     'alias': 'ag02',      #Important because this points to a server file structure by that name.
        ...
        # 'ag_1_4': {
        #     'parent': 'telescope1',
        #     'alias': 'ag04',      #Important because this points to a server file structure by that name.
        #     'desc':  'QHY 174M',
