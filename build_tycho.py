...
# wmd C:/Users/obs/Doc...
tycho_cat = open("../ptr-observatory/support_info/tycho_mag_7.dat", 'r')  #Get set up properly wiht relative file specification
tycho_tuple = []
...
def dist_sort_targets(pRa, pDec, pSidTime):
    ...
    Horizon cull is applied and an anti-flip provision.
    '''
