...
site_config = {
    ...
    'focuser': {
        'focuser1': {
            ...
            'coef_0': 5557,  #  Nominal intercept when Primary is at 0.0 C. 
            'coef_date':  '20210915',    #This appears to be sensible result 44 points -13 to 3C'reference':  6431,    #  Nominal at 10C Primary temperature
            # #F9 setup
        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'generic'],
                        ...
                        ['air',  [0,  0], -800, 420., [2   ,  20], 'ai'],    # 0.  Gains 20120906 Cleak NE sky
                        ['w',    [7,  0],    0, 380., [360 , 170], 'w '],    # 1.
                        ['up',   [1,  0],    0, 4.0,  [2   ,  20], 'up'],    # 2.
                        ['gp',   [2,  0],    0, 240., [.77 ,  20], 'gp'],    # 3.
                        ['rp',   [3,  0],    0, 70.0, [1.2 ,  20], 'rp'],    # 4.
                        ['ip',   [4,  0],    0, 12.0, [.65 ,  20], 'ip'],    # 5.
                        ['z',    [5,  0],    0, 0.79, [1.0 ,  20], 'zs'],    # 6.
                        ['zp',   [0,  9],    0, 0.94, [360 , 170], 'zp'],    # 7.
                        ['y',    [6,  0],    0, 0.10, [360 , 170], 'y '],    # 8.
                        ['EXO',  [8,  0],    0, 180., [360 , 170], 'ex'],    # 9.
                        ['JB',   [9,  0],    0, 42.4, [0.65,  20], 'BB'],    #10.
                        ['JV',   [10, 0],    0, 40.2, [.32 ,  20], 'BV'],    #11.
                        ['Rc',   [11, 0],    0, 22.1, [10  , 170], 'BR'],    #12.
                        ['Ic',   [12, 0],    0, 5.4,  [360 , 170], 'BI'],    #13.
                        ['PL',   [7,  0],    0, 380., [360 , 170], 'PL'],    #14.
                        ['PR',   [0,  8],    0, 64.0, [.32 ,  20], 'PB'],    #15.
                        ['PG',   [0,  7],    0, 160., [30  , 170], 'PG'],    #16.
                        ['PB',   [0,  6],    0, 198., [360 , 170], 'PR'],    #17.
                        ['NIR',  [0, 10],    0, 10.9, [0.65,  20], 'ni'],    #18.
                        ['O3',   [0,  2],    0, 2.15, [360 , 170], 'O3'],    #19.
                        ['HA',   [0,  3],    0, 0.56, [360 , 170], 'HA'],    #20.
                        ['N2',   [13, 0],    0, 0.36, [360 , 170], 'N2'],    #21.
                        ['S2',   [0,  4],    0, 0.31, [0.65,  20], 'S2'],    #22.
                        ['CR',   [0,  5],    0, 0.59, [360 , 170], 'Rc'],    #23.
    ...
    'camera': {
        'camera_1_1': {
            ...
            'settings': {
                ...
                'x_pixel':  3.76,
                'y_pixel':  3.76,
                'pix_scale': 1.0481,     #  asec/pixel F9   0.5751  , F4.9  1.0481         
