        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'generic'],
                        ...
                        ['air',  [0,  0], -800, 22.1, [2   ,  20], 'ai'],    # 1
                        ['w',    [7,  0],    0, 0.20, [360 , 170], 'w '],    # 2
                        ['up',   [1,  0],    0, 22.1, [2   ,  20], 'up'],    # 3
                        ['gp',   [2,  0],    0, 17.4, [.77 ,  20], 'gp'],    # 4
                        ['rp',   [3,  0],    0, 11.0, [1.2 ,  20], 'rp'],    # 5
                        ['ip',   [4,  0],    0, 37.4, [.65 ,  20], 'ip'],    # 6
                        ['z',    [5,  0],    0, 11.6, [1.0 ,  20], 'zs'],    # 7
                        ['zp',   [0,  9],    0, 0.21, [360 , 170], 'zp'],    # 8
                        ['y',    [6,  0],    0, 0.73, [360 , 170], 'Y '],    # 9
                        ['EXO',  [8,  0],    0, 0.21, [360 , 170], 'ex'],    #10
                        ['JB',   [9,  0],    0, 27.5, [0.65,  20], 'BB'],    #11
                        ['JV',   [10, 0],    0, 62.3, [.32 ,  20], 'BV'],    #12
                        ['Rc',   [11, 0],    0, 2.99, [10  , 170], 'BR'],    #13
                        ['Ic',   [12, 0],    0, 0.73, [360 , 170], 'BI'],    #14
                        ['PL',   [7,  0],    0, 0.20, [360 , 170], 'PL'],    #15
                        ['PR',   [0,  8],    0, 62.3, [.32 ,  20], 'PB'],    #16
                        ['PG',   [0,  7],    0, 0.10, [30  , 170], 'PG'],    #17
                        ['PB',   [0,  6],    0, 0.20, [360 , 170], 'PR'],    #18
                        ['NIR',  [0, 10],    0, 27.5, [0.65,  20], 'ni'],    #19
                        ['O3',   [0,  2],    0, 0.21, [360 , 170], 'O3'],    #20
                        ['HA',   [0,  3],    0, 0.20, [360 , 170], 'HA'],    #21
                        ['N2',   [13, 0],    0, 0.20, [360 , 170], 'N2'],    #22
                        ['S2',   [0,  4],    0, 27.5, [0.65,  20], 'S2'],    #23
                        ['CR',   [0,  5],    0, 0.20, [360 , 170], 'Rc'],    #24
                        ['dark', [5,  6],    0, 0.20, [360 , 170], 'dk'],    #25
                        ['dif',  [0,  1],    0, 0.21, [360 , 170], 'df'],    #26
                        ['difw',   [7,  1],  0, 27.5, [0.65,  20], 'dw'],    #27
                        ['difup',  [1,  1],  0, 27.5, [0.65,  20], 'du'],    #28
                        ['difgp',  [2,  1],  0, 27.5, [0.65,  20], 'dg'],    #29
                        ['difrp',  [3,  1],  0, 27.5, [0.65,  20], 'dr'],    #30
                        ['difip',  [4,  1],  0, 27.5, [0.65,  20], 'di'],    #31
                        ['difz',   [5,  1],  0, 27.5, [0.65,  20], 'ds'],    #32
                        ['dify',   [6,  1],  0, 27.5, [0.65,  20], 'dY'],    #33
                        ['difEXO', [8,  1],  0, 27.5, [0.65,  20], 'dx'],    #34
                        ['difJB',  [9,  1],  0, 27.5, [0.65,  20], 'dB'],    #35
                        ['difJV',  [10, 1],  0, 27.5, [0.65,  20], 'dV'],    #36
                        ['difRc',  [11, 1],  0, 27.5, [0.65,  20], 'dR'],    #37
                        ['difIc',  [12, 1],  0, 27.5, [0.65,  20], 'dI']],   #38
                'filter_screen_sort':  [12, 0, 11, 2, 3, 5, 4, 1, 6],   #  don't use narrow yet,  8, 10, 9], useless to try.
                
                'filter_sky_sort': [21, 22, 23, 24, 20, 9, 8, 7]  #  Least to most throughput  8, 10, 9, 7, 6, 5, 3, 2,
            },
        },
    },
