...
site_config = {
    ...
    'agent_wms_enc_active':  True,    #True is the agent is used at a site.
    ...
    'timezone': 'PDT',      
    'latitude': 34.459367,     #Decimal degrees, North is Positive
    'longitude': -119.681145,   #Decimal degrees, West is negative
    ...
    'site_in_automatic_default': "Automatic",   #['Shutdown', 'Maunual', 'Automatic']
    'automatic_detail_default': "Enclosure set to Automatic in configuration.",
    'agent_wx_enc_active':  True,    #True is the agent is used at a site.
    ...
    'enclosure': {
        'enclosure1': {
            ...
            'name': 'Megawan',
            'hostIP':  '10.15.0.65',
            'driver': 'ASCOM.SkyRoof.Dome',    #  ASCOM.SkyRoofHub.Dome'
            'startup_script':  None,
            'recover_script':  None,
...
# =============================================================================
    ...
    'focuser': {
        'focuser1': {
            ...
            'coef_0': 6500,  #20210904 Nominal intercept when Primary is at 0.0 C.
            'coef_date':  '20210904',   #A Guess as to coef_c
            'use_local_temp':  True,
        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'abbreviation'],
                                ...
                                ['CR',      [1, 0],     0,  .59,  [2, 17], 'CR'], # 3
                                ['N2',      [3, 0],     0,  .4,   [2, 17], 'N2'], # 4
                                ['up',      [0, 5],     0,  8.,   [1, 17], 'up'], # 5
                ...
                'filter_sky_sort':     [15, 3, 4, 14, 16,  9, 8, 13, 11, 12, 5, \
    ...
    'camera': {
        ...
        'camera_1_1': {
            ...
            'settings': {
                ...
                'x_field_deg': 0.8042,   # round(4784*0.6051648849005071/3600, 4),   #48 X 32 AMIN  3MIN X 0.5 DEG  
                'y_field_deg': 0.5369,   # round(3194*0.6051648849005071/3600, 4),
                'overscan_x': 24,
                'overscan_y': 34,
                ...
                'default_area':  "Full",
                'bin_modes':  [[2, 2], [3,3], [1,1], [4,4]],     #Meaning fixed binning if list has only one entry
