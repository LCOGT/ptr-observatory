...
Flip-Flat      COM16
Pegasus Astro  COM20
QHY CW2 Filter COM22
QHY600         AstroImaging Equipment

Located on CDK 14 OTA:

Pegasus USB3 is USB2 Multiplexer with Roof, USB2 computer port
...
Pegasus USB3 is USB2 computer port:
...
# =============================================================================
    ...
    'mount': {
        'mount1': {
            'parent': 'enclosure1',
            'name': 'eastpier2',
            'hostIP':  '10.15.0.65',     #Can be a name if local DNS recognizes it.
            'hostname':  'eastpier',
    ...
    'camera': {
        'camera1': {
            ...
            'desc':  'QHY 600M Pro',
            'driver':  "Maxim.CCDCamera",   #'ASCOM.FLI.Kepler.Camera', "ASCOM.QHYCCD.Camera",   #
            ...
            'settings': {
                ...
                'saturate':  55000,
                'areas_implemented': [150, 100, 71, 50, 33, 25, 12.5],
