...
site_config = {
    ...
    'aux_archive_path': 'Q:/000ptr_backup_archive/',  #  Path to auxillary backup disk not on this host.
    ...
    'filter_wheel': {
        "filter_wheel1": {
           ...
           'filter_sky_sort':  [ 2, 1, 4, 11, 0, 12]  #  Least to most throughput 8, 10, 9, 7, 6, 5, 3, 
            },
        },
    },
