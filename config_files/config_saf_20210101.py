...
site_config = {
    ...
    'mount': {
        'mount1': {
            ...
            'east_ra_correction':  -52*0.5751/3600/15,    # 20201230
    ...
    'focuser': {
        'focuser1': {
			...
			'com_port':  None,
            'reference':  6431,    #  Nominal at 10C Primary temperature
            'ref_temp':  10.,    #  Update when pinning reference
            'coef_c': -70.425725,   #  negative means focus moves out as Primary gets colder
            'coef_0': 7125.268,  #  Nominal intercept when Primary is at 0.0 C. 
            'coef_date':  '20201226',    #This appears to be sensible result 44 points -13 to 3C
