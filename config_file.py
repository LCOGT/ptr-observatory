        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'abbreviation'],
                                ...
                                ['N2',      [5, 0],     0, 0.01, [2, 17], 'S2'],   # 5
                                ['S2',      [6, 0],     0, 0.01, [2, 17], 'N2'],   # 6
                                ...
                                ['difr',    [2, 4],     0, 0.01, [2, 17], 'dr'],  # 16
                                ['difi',    [2, 5],     0, 0.01, [2, 17], 'di'],  # 17
                                ['difexo',  [2, 6],     0, 0.01, [2, 17], 'dE'],  # 18
                                ['dark',    [6, 1],     0, 0.01, [2, 17], 'dk']], # 19
                                #Screen = 100; QHY400 ~ 92% DQE   HDR Mode    Screen = 160 sat  20190825 measured.
...
=======
                ...
                'default_area':  "Full",
                'bin_modes':  [[1, 1, 0.469], [2, 2, 0.937], [4, 4, 1.87]],     #Meaning no binning if list has only one entry
                'default_bin':  [2, 2, 0.937],    #Always square and matched to seeing situation by owner
