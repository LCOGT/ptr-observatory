...
site_config = {
    'site': 'saf',
    'alias': 'Apache Ridge Observatory',
...
# =============================================================================
        ...
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [['filter', 'filter_index', 'filter_offset', 'sky_gain', 'screen_gain', 'abbreviation'],
                                ...
                                ["g'", '(4, 0)', '0', '0.01', '20', "g'"],   # 4
                                ["r'", '(5, 0)', '0', '0.01', '20', "r'"],   # 5
                                ["i'", '(6, 0)', '0', '0.01', '160', "i'"],   # 6
                                ['O3', '(7, 0)', '0', '0.01', '160/16', 'O3'],   # 7
                                ['HA', '(8, 0)', '0', '0.01', '160/75', 'HA'],   # 8
                                ['S2', '(9, 0)', '0', '0.01', '160/160','S2'],   # 9
                                ['N2', '(10, 0)', '0', '0.01', '160/80', "N2"],   # 10
                                ['EXO', '(11, 0)', '0', '0.01', '8', 'ex'],   # 11
                                ['air', '(12, 0)', '-1000', '0.01', '5', 'ai'],   # 12
                                ['dark', '(13, 0)', '0', '0.01', '5', 'dk']],   # 13  20200315 This needs to be set up as a \
    ...
    'camera': {
        'camera1': {
            'parent': 'telescope1',
            'alias': 'kb01',      #Important because this points to a server file structure by that name.
