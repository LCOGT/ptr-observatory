    ...
    'filter_wheel': {
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [
                                ['air',     [0, 0], -1000, 72,    [2, 17], 'ai'],   # 0
                                ['Lum',     [0, 1],     0, 0.5,   [2, 17], 'w '],   # 20
                                ['Red',     [4, 0],     0, 0.5,   [2, 17], 'r '],  # 21                                ['JV (Grn)',      [0, 3],     0, 1 [2, 17], 'V '],   # 9
                                ['Green',   [3, 0],     0, 0.5,   [2, 17], 'V '],   # 22
                                ['Blue',    [1, 0],     0, 0.5,   [2, 17], 'B '],   # 23
                                ['w',       [0, 1],     0, 18.3,  [2, 17], 'w '],   # 1
                                #['dif',    [0, 2],     0, 34,    [2, 17], 'df'],   # 2
                                ['O3',      [0, 3],     0, 21,    [2, 17], 'O3'],   # 3
                                ['HA',      [0, 4],     0, 15,    [2, 17], 'HA'],   # 4
                                ['N2',      [0, 5],     0, 6,     [2, 17], 'S2'],   # 5
                                ['S2',      [0, 6],     0, 30,    [2, 17], 'N2'],   # 6
                                ['JB',      [1, 0],     0, 65,    [2, 17], 'B '],   # 7
                                ['gp',      [2, 0],     0, 65,    [2, 17], 'g '],   # 8
                                ['JV',      [3, 0],     0, 1.1,   [2, 17], 'V '],   # 9
                                ['rp',      [4, 0],     0, .32,   [2, 17], 'r '],  # 10
                                ['ip',      [5, 0],     0, .37,   [2, 17], 'i '],  # 11
                                ['EXO',     [6, 0],     0, .62,  [2, 17], 'EX'],  # 12
