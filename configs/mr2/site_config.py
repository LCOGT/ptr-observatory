    ...
    'filter_wheel': {
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [
                                ['air',     [0, 0], -1000, 0.5, [2, 17], 'ai'],   # 0
                                ['Lum',     [1, 0],     0, 0.5, [2, 17], 'w '],   # 20
                                ['Red',     [0, 4],     0, 0.5, [2, 17], 'r '],  # 21                                ['JV (Grn)',      [0, 3],     0, 1 [2, 17], 'V '],   # 9
                                ['Green',   [0, 3],     0, 0.5, [2, 17], 'V '],   # 22
                                ['Blue',    [0, 1],     0, 0.5, [2, 17], 'B '],   # 23
                                ['w',       [1, 0],     0, 0.5, [2, 17], 'w '],   # 1
                                ['dif',     [2, 0],     0, 0.5, [2, 17], 'df'],   # 2
                                ['O3',      [3, 0],     0, 0.5, [2, 17], 'O3'],   # 3
                                ['HA',      [4, 0],     0, 4,245, [2, 17], 'HA'],   # 4
                                ['N2',      [5, 5],     0, 0.5, [2, 17], 'S2'],   # 5
                                ['S2',      [6, 6],     0, 0.735, [2, 17], 'N2'],   # 6
                                ['JB',      [0, 1],     0, 0.5, [2, 17], 'B '],   # 7
                                ['gp',       [0, 2],     0, 0.5, [2, 17], 'g '],   # 8
                                ['JV',      [0, 3],     0, 0.5, [2, 17], 'V '],   # 9
                                ['rp',       [0, 4],     0, 0.5, [2, 17], 'r '],  # 10
                                ['ip',       [0, 5],     0, 0.5, [2, 17], 'i '],  # 11
                                ['EXO',     [0, 6],     0, 0.5, [2, 17], 'EX'],  # 12
                ...
                'filter_sky_sort':     ['S2',  'N2', 'O3', 'i', 'r', 'g',\
    ...
    'camera': {
        'camera_1_1': {
            ...
            'settings': {
                ...
                'saturate':  65000.0, #[[1, 65000], [2,262000], [3,589815], [4, 1048560]] ,   # e-.  This is a close guess, not measured, but taken from data sheet.
                'max_linearity':  55000.,
                ...
                'has_darkslide':  False,
                'darkslide_com':  None,
                'shutter_type': "6-Blade",
                "shutter_compensation_available": True,
