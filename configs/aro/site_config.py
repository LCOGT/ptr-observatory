    ...
    'filter_wheel': {
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'home_filter':  6,
                'default_filter': "w",
                'filter_reference': 6,   # We choose to use W as the default filter.  Gains taken at F9, Ceravolo 300mm
                ...
                'filter_screen_sort':  ['w'],   # don't use narrow yet,  8, 10, 9], useless to try.


                'filter_sky_sort': ['CR', 'S2', 'N2', 'HA']    #  No diffuser based filters
