    ...
    'filter_wheel': {
        "filter_wheel1": {
            ...
            'settings': {
                ...
                'filter_data': [
                        ['air',  [0,  0], -800, 650., [2   ,  20], 'air'],    #0  Gains 20230703 
                        ['EXO',  [8,  0],    0, 615., [360 , 170], 'ex'],     #1
                        ['PL',   [7,  0],    0, 588., [360 , 170], 'PL'],     #2
                        ['gp',   [2,  0],    0, 513., [.77 ,  20], 'gp'],     #3
                        ['PB',   [0,  6],    0, 344,  [360 , 170], 'PR'],     #4
                        ['NIR',  [0, 10],    0, 214., [0.65,  20], 'ni'],     #5
                        ['JV',   [10, 0],    0, 213., [.32 ,  20], 'BV'],     #6
                        ['Rc',   [11, 0],    0, 209., [10  , 170], 'BR'],     #7
                        ['ip',   [4,  0],    0, 191., [.65 ,  20], 'ip'],     #8
                        ['PG',   [0,  7],    0, 187., [30  , 170], 'PG'],     #9
                        ['JB',   [9,  0],    0, 169., [0.65,  20], 'BB'],     #10
                        ['rp',   [3,  0],    0, 169., [1.2 ,  20], 'rp'],     #11
                        ['PR',   [0,  8],    0, 137., [.32 ,  20], 'PB'],     #12
                        ['Ic',   [12, 0],    0, 115., [360 , 170], 'BI'],     #13
                        ['zp',   [0,  9],    0, 47.6, [360 , 170], 'zp'],     #14    # NB I think these may be backward labeled,
                        ['zs',   [5,  0],    0, 57.4, [1.0 ,  20], 'zs'],     #15    # NB ZP is a broader filter than zs.
                        ['O3',   [0,  2],    0, 20.0, [360 , 170], 'O3'],     #16    #guess
                        ['CR',   [0,  5],    0, 15.0, [360 , 170], 'CR'],     #17    #Guess
                        ['HA',   [0,  3],    0, 11.7, [360 , 170], 'HA'],     #18
                        ['up',   [1,  0],    0, 7.61, [2   ,  20], 'up'],     #19
                        ['N2',   [13, 0],    0, 5.67, [360 , 170], 'N2'],     #20
                        ['S2',   [0,  4],    0, 5.11, [0.65,  20], 'S2'],     #21
                        ['y',    [6,  0],    0, 0.28, [360 , 170], 'y '],     #22     #This filter looks defective
