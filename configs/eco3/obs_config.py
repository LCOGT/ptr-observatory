...
obs_id = 'eco3' # THIS IS THE NAME OF THIS OBSERVATORY
...
# These are options to minimise diskspace for calibrations
    ...
    'telescope': {                            #Note telescope == OTA  Optical Tube Assembly.
        'Main OTA': {
            ...
            'instrument names':  ['eco3zwo'],
            'instrument aliases':  ['SBIG16803'],
            'configuration': {
                  "position1": ["darkslide1", "RGGB", "eco3zwo"]
                  },
            'camera_name':  'eco3zwo',
...
#     },
    ...
    'focuser': {
        'focuser': {
            ...
            'reference': 3600,    #  20210313  Nominal at 10C Primary temperature
    ...
    'selector': {
        'selector': {
            ...
            'cameras':  ['eco3zwo'], # , 'camera_1_2', None, 'camera_1_4'],
    ...
    'camera': {
        'eco3zwo': {
            'parent': 'Main OTA',
            'name': 'eco3zwo',      #  Important because this points to a server file structure by that name.
            'desc':  'SBIG16803',
